...
class Appointment(models.Model):
    ...
    id_facility = models.ForeignKey('DwFacility', models.DO_NOTHING, db_column='id_facility', blank=True, null=True)
...
class Client(models.Model):
    ...
    garnment = models.CharField(max_length=100, blank=True, null=True)
...
class DwFacility(models.Model):
    id_facility = models.CharField(primary_key=True, max_length=250)
    infos = models.CharField(max_length=250, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'DW_FACILITY'
...
class ReferralService(models.Model):
    id_app = models.ForeignKey(Appointment, models.DO_NOTHING, db_column='id_app')
