...
class Appointment(models.Model):
    ...
    created = models.CharField(blank=True, null=True, max_length=40)
    last_updated = models.CharField(blank=True, null=True, max_length=40)
...
class Sms(models.Model):
    ...
    code_questionnaire = models.CharField(max_length=20)
    date_soumission = models.CharField(blank=True, null=True, max_length=40)
